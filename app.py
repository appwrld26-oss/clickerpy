...
# --- اتصال آمن ومباشر بقاعدة البيانات دون مشاكل شهادات SSL ---
@st.cache_resource
def init_connection():
    try:
...
# =====================================================================
# 2. إعداد الجداول وكافة العلاقات
# =====================================================================
def setup_tables():
    try:
        cur = conn.cursor()
...
# 2. إدارة التحديثات الإجبارية (محدثة لدفع الرابط والإشعار الفوري لكل التطبيقات المحملة)
elif choice == "🚀 إدارة التحديثات الإجبارية":
    st.title("🚀 إدارة التحديثات الإجبارية العامة ونشر الرابط الفوري")
    ...
    with st.form("update_form"):
        ...
        if st.form_submit_button("حفظ ونشر التحديث الإجباري وإشعار البار لكل التطبيقات 🚀"):
            ...
            # دفع رابط التحديث ورسالته مباشرة عبر خاصية الـ PUSH لتصل حتى للتطبيقات المحملة مسبقاً
