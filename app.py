...
# =====================================================================
# 0. نظام الحماية الشامل لمنع الشاشة البيضاء
# =====================================================================
try:
    # إعدادات الصفحة
    ...
    if conn is None: 
        st.error("❌ فشل الاتصال بقاعدة البيانات. يرجى التحقق من بيانات الاتصال أو حالة السيرفر على DigitalOcean.")
        st.stop()
    ...
    st.error(f"🚨 حدث خطأ غير متوقع أدى إلى توقف الواجهة: {fatal_error}")
